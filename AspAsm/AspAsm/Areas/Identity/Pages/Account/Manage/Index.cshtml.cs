...
namespace AspAsm.Areas.Identity.Pages.Account.Manage
{
    public partial class IndexModel : PageModel
    {
        ...
        private readonly SignInManager<AspAsmUser> _signInManager;
        private readonly IEmailSender _emailSender;

        public IndexModel(
            UserManager<AspAsmUser> userManager,
            SignInManager<AspAsmUser> signInManager,
        ...
        private void SendMail(string receiveMail, string receiveName, string mailContent)
        {
            ...
            NetworkCredential myCreds = new NetworkCredential("linhwhite98@gmail.com", "jxcqgipsjxmeebgr");
